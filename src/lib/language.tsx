...
export const translations = {
  ...
  bn: {
    ...
    // Profile page
    profileTag: "কোম্পানি প্রোফাইল",
    profileTitle: "স্টারলাইন বিল্ডার্স লিঃ-এর ভেতরে",
    profileSubtitle: "আমাদের যাত্রা, নেতৃত্ব, কর্মীবৃন্দ, মাইলফলক ও আইনি স্বীকৃতির এক ঝলক।",
    historyTitle: "আমাদের ইতিহাস",
    historyP1: "২০০৮ সালে প্রতিষ্ঠিত স্টারলাইন বিল্ডার্স লিঃ একটিমাত্র স্বপ্ন নিয়ে যাত্রা শুরু করে — সৎ কারিগরি, স্বচ্ছ লেনদেন ও সময়মত হস্তান্তরের মাধ্যমে ঢাকার প্রিমিয়াম জীবনযাত্রাকে নতুন রূপ দেওয়া।",
    historyP2: "মাত্র ৫ জন প্রকৌশলীর ছোট স্টুডিও থেকে আমরা আজ ২০০+ সদস্যের একটি দলে পরিণত হয়েছি, যারা বাংলাদেশের সবচেয়ে মর্যাদাপূর্ণ এলাকাগুলোতে ৫০+ ল্যান্ডমার্ক প্রকল্প সরবরাহ করেছেন।",
    historyP3: "আজ স্টারলাইন মানেই বিশ্বাস — ২০০+ পরিবারের পছন্দ এবং ডিজাইন, নিরাপত্তা ও আফটার-সেলস সেবায় নতুন মানদণ্ড স্থাপনকারী।",
    milestonesTitle: "গুরুত্বপূর্ণ মাইলফলক",
    boardTitle: "পরিচালনা পর্ষদ",
    boardSubtitle: "যাঁরা আমাদের যাত্রাকে দিকনির্দেশনা দেন।",
    chairman: "চেয়ারম্যান",
    managingDirector: "ব্যবস্থাপনা পরিচালক",
    director: "পরিচালক",
    executiveDirector: "নির্বাহী পরিচালক",
    employeesTitle: "আমাদের কর্মীবৃন্দ",
    employeesSubtitle: "প্রতিটি স্টারলাইন প্রকল্পের পিছনে নিবেদিত দল।",
    ...
    employeesCount: "দলের সদস্য",
    departmentsCount: "বিভাগ",
    newsTitle: "আপডেট ও সাম্প্রতিক সংবাদ",
    newsSubtitle: "স্টারলাইনের সাম্প্রতিক খবরে আপডেট থাকুন।",
    readMore: "আরও পড়ুন",
    credentialsTitle: "সার্টিফিকেশন ও আইনি স্বীকৃতি",
    credentialsSubtitle: "সম্পূর্ণ লাইসেন্সপ্রাপ্ত, নিবন্ধিত ও সম্মতিপূর্ণ।",
    rehabMember: "রিহ্যাব সদস্য",
    rehabMemberDesc: "বাংলাদেশ রিয়েল এস্টেট ও হাউজিং অ্যাসোসিয়েশনের নিবন্ধিত সদস্য।",
    tradeLicense: "ট্রেড লাইসেন্স",
    tradeLicenseNo: "লাইসেন্স নং: TRAD/DSCC/000123/2008",
    tinCertificate: "টিআইএন সার্টিফিকেট",
    tinNo: "টিআইএন: ১২৩৪৫৬৭৮৯০১২",
    binCertificate: "বিআইএন / ভ্যাট নিবন্ধন",
    binNo: "বিআইএন: 000123456-0202",
    incorporationCert: "ইনকর্পোরেশন সার্টিফিকেট",
